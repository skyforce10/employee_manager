      ...
      <div class="row" style="font-size: 18px;">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('company_exists') is-invalid @enderror" id="input_company_name" name="input_company_name" required oninvalid="this.setCustomValidity('Fill Company Name Field')" oninput="this.setCustomValidity('')" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="input_company_address" name="input_company_address" rows="4" cols="50" required oninvalid="this.setCustomValidity('Fill Address Field')" oninput="this.setCustomValidity('')" autocomplete="off"></textarea>
          </div>
          <div class="form-group">
            <label for="input_company_website">Website</label>
            <input type="text" class="form-control @error('input_company_website') is-invalid @enderror" id="input_company_website" name="input_company_website" required oninvalid="validateURL(this)" oninput="setCustomValidity('')" autocomplete="off">
        ...
        <div class="col-md-6 text-center" id="profilePicture" data-path="{{ public_path('company_logo') }}">
          ...
          <label class="btn btn-secondary btn-sm" style="font-size: 18px;">
            ...
            <input type="file" id="company_logo" name="company_logo" style="display:none;" accept="image/*" onchange="previewImage(this)" />
          </label>
...
<script>
  $(document).ready(function() {
    $("#input_company_code").val('{{$company->id}}');
    $("#input_company_name").val('{{$company->name}}');
    $("#input_company_address").val('{{$company->address}}');
    $("#input_company_website").val('{{$company->website}}');

    var imagePathvar = '{{$company->logo}}';
  var preview = document.getElementById('image-preview');
  preview.innerHTML = '';
  var img = document.createElement('img');
